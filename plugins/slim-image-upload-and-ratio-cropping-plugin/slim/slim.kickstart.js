   ...
   */
		...
		value: function _upload(data, callback) {
			...
			function (obj) {
				...
				/*
				$.ajax({
						url: "http://localhost/alarinna/profile/image_uploader",
						type: "POST",
						data: '2',
						
						success: function(data) {
						
						$("#redo").html(data).fadeIn("10000");
					...
					*/
					...
					//var data = $.parseJSON(obj);//parse JSON

					//alert(obj);
    			
				$('#redo').load('http://localhost/alarinna/profile/image_uploader');
			},
