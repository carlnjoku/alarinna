...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/pages/scripts/form-wizard1.js" type="text/javascript"></script>
            ...
            form.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $('#submit_form').submit(function(e){
                        ...
                        $.ajax({
                        url: 'http://localhost/neo4j-alarinna/web/profile',
                        //url: 'http://localhost/alarinna/plugins/slim-image-upload-and-ratio-cropping-plugin/server/async.php',
