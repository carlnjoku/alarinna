...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | The Ultimate Multi-purpose Bootstrap Admin Dashboard Theme | Theme #3 | User Login 4</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Africa #1 dating website Nigeria, South Africa, Kenya, Ghana"
            name="description" />
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="register-form">
				...
				<input type="hidden" name="longitude" value="64839" />
                <input type="hidden" name="latitude"  value="453" />
				...
				<div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Month</label>
                    <select name="month" class="form-control">
                        <option value="">Month </option>
                        <option value="AF">January</option>
