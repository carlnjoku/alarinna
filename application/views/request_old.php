                                        ...
                                        <div class="portlet light portlet-fit ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject bold font-green uppercase"> MY Requests</span>
                                                    <span class="caption-helper">Latest requests</span>
                                                </div>
                                                    ...
                                                    <ul class="mt-container">
                                                        <li class="mt-item">
                                                            ...
                                                            <div class="mt-timeline-content">
                                                                <div class="mt-content-container">
                                                                    <div class="mt-title">
                                                                        <h3 class="mt-content-title">Drinkup Request</h3>
                                                                    </div>
                                                                    <div class="mt-author">
                                                                        <div class="mt-avatar">
                                                        ...
                                                        <li class="mt-item">
                                                            ...
                                                            <div class="mt-timeline-content">
                                                                <div class="mt-content-container bg-white border-grey-steel">
                                                                    <div class="mt-title">
                                                                        <h3 class="mt-content-title">Photo Request</h3>
                                                                    </div>
                                                                    <div class="mt-author">
                                                                        <div class="mt-avatar">
                                                                    ...
                                                                    <div class="mt-content border-grey-steel">
                                                                        ...
                                                                        <a href="javascript:;"
                                                                            class="btn btn-circle btn-outline green-jungle">Download Shipment List</a>
                                                        ...
                                                        <li class="mt-item">
                                                            ...
                                                            <div class="mt-timeline-content">
                                                                <div class="mt-content-container">
                                                                    <div class="mt-title">
                                                                        <h3 class="mt-content-title">Personality Request</h3>
                                                                    </div>
                                                                    <div class="mt-author">
                                                                        <div class="mt-avatar">
                                                                            <img src="../assets/pages/media/users/avatar80_2.jpg" />
                                                            ...
                                                            <div class="mt-timeline-content">
                                                                <div class="mt-content-container bg-purple-medium bg-font-purple-medium border-right-before-purple-medium border-purple-medium">
                                                                    ...
                                                                    <div class="mt-content border-white">
                                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde.</p>
                                                                        <a href="javascript:;"
                                                                            class="btn btn-circle white">View Summary</a>
                                                                        <div class="btn-group pull-right">
