var FormValidation = function () {
    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            var form1 = $('#form_update_member_details');
                ...
                success: function (label) {
                 ...
                 submitHandler: function (form) {
                    // comment out AJAX for demo
                        ...
                        var frmData = $('#form_update_member_details').serializeArray().reduce(function(a, x) { a[x.name] = x.value; return a; }, {});
                    ...
                    $.ajax({
                        dataType: 'html',
                        type: 'post',
                        url: 'http://localhost/neo4j-alarinna/web/update_member_details',
    ...
    // Reset Password
    var handleValidation20 = function() {
        // for more info visit the official plugin documentation: 
            // http://docs.jquery.com/Plugins/Validation
                ...
                success: function (label) {
                 ...
                 submitHandler: function (form) {
                    // comment out AJAX for demo
                        ...
                        var frmData = $('#form-change-password').serializeArray().reduce(function(a, x) { a[x.name] = x.value; return a; }, {});
                    ...
                    $.ajax({
                        dataType: 'html',
                        type: 'post',
                        url: 'http://localhost/neo4j-alarinna/web/change_password',
                        data: data1,
    ...
    // Edit Aboutme
    var handleValidation30 = function() {
        // for more info visit the official plugin documentation: 
            // http://docs.jquery.com/Plugins/Validation

            var form30 = $('#form_edit_aboutme2222');
            var error30 = $('.alert-danger', form30);
            var success30 = $('.alert-success', form30);
                ...
                success: function (label) {
                 ...
                 submitHandler: function (form) {
                    // comment out AJAX for demo
                        ...
                        var frmData1 = $('#form_edit_aboutme2222').serializeArray().reduce(function(a, x) { a[x.name] = x.value; return a; }, {});
                                        
                        var data2 = JSON.stringify(frmData);
